            ...
            <div className="grid gap-10 md:grid-cols-3 lg:gap-12">
              <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm">
                <div className="p-8 lg:p-10">
                  ...
                  <p className="mt-3 leading-relaxed text-slate-600">
                    Click the button below to join our Google Group. This adds you to the approved
                    testers list automatically — no manual approval needed.
                  </p>
                  <div className="mt-6">
                    <Link
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm">
                <div className="p-8 lg:p-10">
                  ...
                  <p className="mt-3 leading-relaxed text-slate-600">
                    Open the Play Store page and tap &ldquo;Join the test&rdquo;. You may need to
                    wait a few minutes after joining the group for access to activate.
                  </p>
                  <div className="mt-6">
                    <Link
                      href={PLAY_STORE_URL}
              ...
              <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm">
                <div className="p-8 lg:p-10">
                  ...
                  <h2 className="mt-6 text-xl font-semibold text-slate-900">
                    Install OrbitSafe VPN
                  </h2>
                  <p className="mt-3 leading-relaxed text-slate-600">
                    After accepting the test, tap Install. OrbitSafe VPN will appear in your Android
                    app list and you&apos;re ready to go.
                  </p>
                </div>
              </div>
            </div>
